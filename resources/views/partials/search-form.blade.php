...
<h2 class="widget-title text-white d-inline-block">categories</h2>
</div>
<ul class="list-unstyled widget-list">
<li><a href="#!" class="d-flex font-primary text-white">Four seasone
    <small class="ml-auto">(1)</small></a>
</li>
<li><a href="#!" class="d-flex font-primary text-white">Newyork city
    <small class="ml-auto">(2)</small></a>
</li>
<li><a href="#!" class="d-flex font-primary text-white">Photobooth
    <small class="ml-auto">(1)</small></a>
</li>
<li><a href="#!" class="d-flex font-primary text-white">Photography
    <small class="ml-auto">(2)</small></a>
</li>
<li><a href="#!" class="d-flex font-primary text-white">Videography
    <small class="ml-auto">(1)</small></a>
</li>
</ul>
</div>
